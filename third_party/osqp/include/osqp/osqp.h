 ...
 */
c_int osqp_setup(struct OSQPWorkspace **workp, const OSQPData *data,
 ...
 */
c_int osqp_update_bounds(struct OSQPWorkspace *work, const c_float *l_new,
                         const c_float *u_new);
 ...
 * @return      Exitflag
 */
c_int osqp_warm_start(struct OSQPWorkspace *work, const c_float *x,
                      const c_float *y);
 ...
 */
c_int osqp_update_P(struct OSQPWorkspace *work, const c_float *Px_new,
 ...
 *                                 <0: error in the update
 */
c_int osqp_update_A(struct OSQPWorkspace *work, const c_float *Ax_new,
 ...
 *                                 <0: error in the update
 */
c_int osqp_update_P_A(struct OSQPWorkspace *work, const c_float *Px_new,
                      const c_int *Px_new_idx, c_int P_new_n,
 ...
 * @return               Exitflag
 */
c_int osqp_update_eps_prim_inf(struct OSQPWorkspace *work,
 ...
 * @return               Exitflag
 */
c_int osqp_update_eps_dual_inf(struct OSQPWorkspace *work,
 ...
 * @return                      Exitflag
 */
c_int osqp_update_scaled_termination(struct OSQPWorkspace *work,
 ...
 * @return                        Exitflag
 */
c_int osqp_update_check_termination(struct OSQPWorkspace *work,
 ...
 * @return                     Exitflag
 */
c_int osqp_update_polish_refine_iter(struct OSQPWorkspace *work,
 ...
 * @return                 Exitflag
 */
c_int osqp_update_time_limit(struct OSQPWorkspace *work,
